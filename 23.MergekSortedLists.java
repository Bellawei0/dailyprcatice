...
// Space complexity : O(n) Creating a new linked list costs O(n)O(n) space.
...
// O(k) The code above present applies in-place method which cost O(1)O(1) space.
